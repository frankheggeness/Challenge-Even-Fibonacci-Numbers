...
describe('Sum of odd numbers in the Fibonacci sequence', function(){
  it('should return the sum of all odd Fibonacci numbers when given 13', function(){
    var sum = fibonacciNums.oddFibs( 13 );
    sum.should.equal(9);
  });
});